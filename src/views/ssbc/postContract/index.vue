<template>
  <div class="app-container">
    <el-main style="padding-left:20%;padding-right:30%">
      <el-alert
        title="智能合约编辑与上传"
        type="info"
    ...
    <el-form>
      ...
      <el-form-item label="合约名称" label-width="10%" style="margin-right:5%">
      ...
      <el-form-item label="合约生成" label-width="25%">
        <el-col :span="14">
      ...
      <el-form-item style="margin-left:15%;margin-right:20%">
        <codemirror v-model="form.code" :options="cmOption" />
      </el-form-item>
      <el-form-item style="margin-top:20px">
        <el-col :span="10" :offset="9">
          <el-button type="primary" :disabled="disable" style="alignment: center; width:30% " @click="postContract">发布合约</el-button>
        </el-col>
      </el-form-item>
    </el-form>
    <el-dialog
